...
# pump_replacement_deploy documentation build
...
from pump_replacement_deploy import __version__ as release

# -- Project information -----------------------------------------------------

project = "pump_replacement_deploy"
author = "QuantumBlack"
...
htmlhelp_basename = "pump_replacement_deploydoc"
...
latex_documents = [
    (
        master_doc,
        "pump_replacement_deploy.tex",
        "pump_replacement_deploy Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "pump_replacement_deploy",
        "Project pump_replacement_deploy codebase.",
        "Data-Science",
    )
]
